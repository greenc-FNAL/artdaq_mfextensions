...
void ma_action_factory::reg(std::string const& func_name, gen_act_t f)
{
	get_map().insert(std::make_pair(func_name, f));
}

ma_action*
ma_action_factory::create_instance(std::string const& func_name, ma_rule const* rule, pset_t const& pset)
{
