...
, time_  ( msg.timestamp() )
{
  ...
  case mfviewer::SeverityCode::DEBUG   : 
      sev_ = SDEBUG;   color_.setRgb(  80,  80,  80 ); break;

  case mfviewer::SeverityCode::INFO    : 
      sev_ = SINFO;    color_.setRgb(   0, 128,   0 ); break;

  case mfviewer::SeverityCode::WARNING : 
      sev_ = SWARNING; color_.setRgb( 224, 128,   0 ); break;

  case mfviewer::SeverityCode::ERROR   : 
      sev_ = SERROR;   color_.setRgb( 255,   0,   0 ); break;
  ...
  text_  += QString(msg.severity().c_str()) + " / "
          + QString(msg.category().c_str()) + "\n"
          + QString(msg.timestr().c_str())  + "\n"
          + QString(msg.hostname().c_str()) + " ("
          + QString(msg.hostaddr().c_str()) + ")\n"
  ...
  {
  case mfviewer::SeverityCode::DEBUG   : 
      sev_ = SDEBUG;   text_ += QString("#505050>"); break;
  case mfviewer::SeverityCode::INFO    : 
      sev_ = SINFO;    text_ += QString("#008000>"); break;
  case mfviewer::SeverityCode::WARNING : 
      sev_ = SWARNING; text_ += QString("#E08000>"); break;
  case mfviewer::SeverityCode::ERROR   : 
      sev_ = SERROR;   text_ += QString("#FF0000>"); break;
